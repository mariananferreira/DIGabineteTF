              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="secondary relative overflow-hidden px-6 py-10 sm:px-10 xl:p-12">
                  ...
                  <div className="contactAlign">
                    ...
                    {/* ✅ INFO LEGAL  */}
                    <div className="mt-6 rounded-2xl border border-white/30 bg-white/10 p-4 shadow-sm backdrop-blur-sm">
                      <div className="flex items-start gap-3">
                        ...
                        >
                          <path d="M12 2a5 5 0 0 0-5 5v3.09A2.994 2.994 0 0 0 5 13v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7a2.994 2.994 0 0 0-2-2.91V7a5 5 0 0 0-5-5Zm-3 5a3 3 0 1 1 6 0v3H9V7Zm10 6v7H5v-7a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1Z" />
                        </svg>
                        ...
                        <div className="min-w-0">
                          ...
                          <dl className="mt-2 space-y-1 text-sm">
                            <div className="flex flex-wrap items-baseline gap-x-2">
                              <dt className="opacity-80">Certidão de Registo:</dt>
                              <dd className="font-medium tracking-wide">
                                E179175
                              </dd>
                            </div>
                            <div className="flex flex-wrap items-baseline gap-x-2">
                              <dt className="opacity-80">Licença de Funcionamento:</dt>
                              <dd className="font-medium tracking-wide">
                                26245/2025
                              </dd>
                            </div>

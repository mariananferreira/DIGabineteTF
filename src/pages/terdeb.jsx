          ...
          <section className="flex flex-col items-center gap-8 sm:flex-row">
            ...
            <div className="mb-12">
              <p className="text text-justify leading-relaxed">
                ...
                <br />
                <br />
                O meu percurso académico passou pela Escola Superior de Saúde do
                Instituto Politécnico do Porto e ao longo destes anos, fui
                adquirindo experiência na intervenção de questões relacionadas
                às Perturbações da Comunicação, Linguagem e Fala, bem como no

...
export default function TerInes() {
  return (
    <>
          ...
          >
            ...
            <div className="mx-auto w-full max-w-[320px] lg:mx-0">
              ...
              >
                <Image
                  src={ines}
                  alt="Dra. Inês Leite, Terapeuta da Fala"
                  fill
                  priority
                  sizes="320px"
            ...
            <div>
              ...
              >
                ...
                <p>
                  Formei-me na Escola Superior de Saúde do Instituto
                  Politécnico do Porto (ESS). Neste meu percurso
                  especializei-me na área Pediátrica e é nesta área que me
                  sinto mais feliz e completa.
                </p>
                <p>
                  Sou especialista em Perturbações da Comunicação, Linguagem
                  e Fala, pela CRIAP, e em Perturbações da Comunicação,
                  Relação e Autismo, pela SeedGo.
                </p>

                <p>
                  Realizo intervenção com crianças e com estas diversas
                  perturbações desde que terminei a licenciatura.
                </p>
              </div>
            ...
            {/*   <div
              ...
              >
                ...
                <p>
                  O Centro Terapêutico DI é para mim, ao nível pessoal e
                  profissional, um grande desafio. Poderão sempre contar com
                  a minha sinceridade, dedicação e profissionalismo.
                </p>

                <p>
                  Espero que o nosso projeto auxilie muitas famílias e
                  crianças nesta viagem que é a Terapia da Fala.
                </p>
              </div>

          ...
          <section className="flex flex-col items-center gap-8 sm:flex-row">
            ...
            <div className="mb-12">
              <p className="text text-justify leading-relaxed">
                ...
                Universidade da Maia e Membro Efetivo da Ordem dos Psicólogos
                Portugueses (Cédula Profissional 29357).
                <br />
                <br />
                No meu percurso profissional tenho vindo a acompanhar crianças,
                jovens e adultos. No entanto, tenho especial gosto e interesse
                por acompanhar crianças e jovens. A minha área de formação, que
                tanto gosto, é clínica e da saúde. Assim sendo, de forma a
                manter-me sempre atualizada e enriquecer o meu conhecimento para
                poder oferecer um acompanhamento e intervenção de qualidade,
                tenho vindo a realizar formações nesse âmbito.
                <br />
                <br />
                Ao longo da minha prática profissional, tenho vindo a adquirir
                experiência na avaliação e intervenção com crianças e jovens com
                ...
                pela Ordem dos Psicólogos Portugueses para a prática
                profissional.
              </p>
            </div>
          </section>
